...
$('.slider_section6').slick({
  slidesToShow: visable_slides,
  slidesToScroll: 1,
  autoplay: true,
  autoplaySpeed: 2000,
});
...
var lightbox = document.querySelector('.LigthboxContent img'),
  ...
  caroGallery_items = $('.slider_section6 .slider_item'),
...
//Generate Gallery
caroGallery_items.each(function(index) {
  var imageFull_url = $(this).attr('data-full-src');
