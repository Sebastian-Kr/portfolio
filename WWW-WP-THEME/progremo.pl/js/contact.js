...
// END Mobile customization
        

     $("#map").gmap3({
  map:{
    options:{
   key: 'AIzaSyBNmq1uCSS35B6ddQ01N9r2D0qf3XHKmG4',
           center:[49.998412, 20.816793],
           zoom: zm,
           styles: styles,
           scrollwheel: false,
  ...
  marker:{
    values:[
      {latLng:[mapka.gps11, mapka.gps12], data: mapka.desc1, options:{icon: "https://progremo.pl/wp-content/themes/firma-theme/img/mapicon.png", animation: google.maps.Animation.BOUNCE}},
      {latLng:[mapka.gps21, mapka.gps22], data: mapka.desc2, options:{icon: "https://progremo.pl/wp-content/themes/firma-theme/img/mapicon.png", animation: google.maps.Animation.BOUNCE}}
    ],
    options:{
      draggable: false
    },
